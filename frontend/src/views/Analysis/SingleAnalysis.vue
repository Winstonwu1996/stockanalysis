                ...
                <div class="discuss-panel">
                  <div class="discuss-header">
                    <div class="discuss-title">
                      ...
                      <span>追问讨论</span>
                      <span class="discuss-hint">对报告里的论据继续提问，AI 带着报告上下文回答</span>
                    </div>
                  ...
                  <div v-if="discussMessages.length" class="discuss-messages">
                    ...
                    >
                      <div class="discuss-bubble" v-html="formatReportContent(m.content)"></div>
                    </div>
